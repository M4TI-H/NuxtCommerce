...
<template>
  ...
  <div class="w-88 flex flex-col gap-4">
    <div class="h-[10rem] bg-neutral-600">
    ...
    <div class="w-full flex justify-between gap-4 px-4">
      ...
      <SelectButton v-model="newData.isPublic" size="small" class="max-w-44"
  ...
  <span class="w-full flex items-center justify-center gap-16 mt-auto">
    <Button @click="emit('cancel')" label="Cancel" class="w-24 h-[2.5rem]"/>
    <Button @click="handleEdit" label="Confirm" class="w-24 h-[2.5rem]"/>
  </span>
</template>